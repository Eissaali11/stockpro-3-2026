...
- تحكم لحظي في أداء الفنيين: تتبع الكميات المباعة والمتبقية والأعلى مبيعًا حسب الفني/الصنف/المنطقة.
...
- تتبع مبيعات الفنيين: الكميات المباعة، الكميات المتبقية، الأعلى مبيعًا (فني/صنف/منطقة/فترة).
...
### 6.3.1 تتبع أداء مبيعات الفنيين
...
- `GET /api/sales/technicians/top`
  ...
  - المخرجات: ترتيب الفنيين الأعلى مبيعًا
...
- قسم المبيعات:
  - العملاء
  - فواتير المبيعات
  - لوحة أداء مبيعات الفنيين (المباع/المتبقي)
  - تقرير أعلى الفنيين مبيعًا
...
- احتساب الكمية المتبقية بعد كل عملية بيع على مستوى الفني/الصنف.
- تقرير Ranking للأعلى مبيعًا (فنيين وأصناف).
...
- Integration Tests:
  ...
  - صحة مؤشرات المبيعات اليومية للفنيين (sold vs remaining)
- UAT Scenarios:
  - فاتورة مبيعات + تحصيل
  - بيع من فني محدد ثم التأكد من خصم الكمية وتحديث مؤشر المتبقي
...
- توفر تقرير مبيعات فني دقيق يوضح:
...
- تتبع مبيعات الفنيين (مباع/متبقي) مع تقرير أعلى المبيعات.
